...
<div class="container" style="display: flex; justify-content: flex-start; margin-top: 50px; margin-bottom: 50px;">
    ...
    <div style="max-width: 65%;margin-right: 0px;">
        ...
        <p style="margin-bottom: 50px;">My broad research field is empirical microeconomics which integrates economic theory with empirical evidence by using rigorous econometric analysis to study policy-relevant questions. In particular, my research covers a wide range of topics in empirical IO, household finance, and labor economics.</p>
        <h3 style="margin-top: 15px;">Contact</h3>
