...
<div class="container" style="display: flex; justify-content: space-around; margin-top: 50px; margin-bottom: 50px;">
    ...
    <div class="responsive-div">
        ...
        <h3>Contact</h3>
            <span class="material-icons-sharp icon-text">email</span> nzhao [at] swufe.edu.cn<br/>
            <span class="material-icons-sharp icon-text">call</span> +86 (28) 8709 9030<br/> 
            <span class="material-icons-sharp icon-text">business</span> 503 RIEM Building, 55 Guanghuacun St., Chengdu, Sichuan 610074, China<br/>
            <a href="https://riem.swufe.edu.cn/info/1052/1534.htm" class="icon-text"> <span class="material-icons-sharp">launch</span> SWUFE RIEM Faculty Profile</a><br/> 
    </div>
</div>
