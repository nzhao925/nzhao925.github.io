...
<div class="container" style="display: flex; justify-content: space-around; margin-top: 50px; margin-bottom: 50px;">
    ...
    <div class="responsive-div">
        ...
        <h3>Contact</h3>
            ...
            <span class="material-icons-outlined">503 RIEM Building, Guanghua Campus<br/>Southwestern University of Finance and Economics<br/>Chengdu, Sichuan 610074<br/>P. R. China<br/><br/></span>
    </div>
</div>
